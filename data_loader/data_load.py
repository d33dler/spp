    ...
    def load_data(self, mode, dataset_directory, F_txt):
        ...
        if mode == 'train':
            ...
            valset = CSVLoader(
                ...
                augmentations=None,
                post_process=post_process,
                episode_num=episode_val_num, way_num=way_num, shot_num=shot_num, query_num=query_num, av_num=av_num
            )
        testset = CSVLoader(
            ...
            augmentations=None,
            post_process=post_process,
            episode_num=episode_test_num, way_num=way_num, shot_num=shot_num, query_num=query_num, av_num=av_num
        )
        if mode == 'train':
